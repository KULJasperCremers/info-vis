function satisfaction(cdata, div_id) {
    ...
    var hapinessData = querySurveyDataCountryYearColumn(aggregatedsurveyData,years,countryCodes[selectedCountry],selectedElectionYearIndex_To,"satisfaction")["sum"];
